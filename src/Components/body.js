...
class bodyClass extends Component {
  ...
  <Card.ImgOverlay>
    ...
    <Card.Title style={{ color: 'black' }}> Weather :{this.props.description}</Card.Title>
    <Card.Title style={{ color: 'black' }}>{this.props.date}</Card.Title>
    <Card.Title style={{ color: 'black' }}>Wind Direction : {this.props.wind}</Card.Title>
